...
if __name__ == '__main__':
    ...
    for num in range(0,260):
        ...
        originname=noiseimages[num].split('/')[1].rstrip('.png')
        a_mf_name=originname.replace('origin','a_mf')+'.png';
        b_amf_name = originname.replace('origin', 'b_amf') + '.png';
        c_namf_name = originname.replace('origin', 'c_namf') + '.png';
        d_pro1_name = originname.replace('origin', 'd_pro1') + '.png';
        e_pro2_name = originname.replace('origin', 'e_pro2') + '.png';
        f_pro3_name = originname.replace('origin', 'f_pro3') + '.png';
        g_pro4_name = originname.replace('origin', 'g_pro4') + '.png';
        h_pro5_name = originname.replace('origin', 'h_pro5') + '.png';

        mf_byopencv=cv2.medianBlur(noisy_img, 3)
        mf_byopencv_psnr=cv2.PSNR(img, mf_byopencv)
        cv2.imwrite(a_mf_name,mf_byopencv)
        ...
        cv2.imwrite(b_amf_name, amf_bykim)
        ...
        cv2.imwrite(c_namf_name, namf_bykim)
        ...
        cv2.imwrite(d_pro1_name, proposed1_bykim)
        ...
        cv2.imwrite(e_pro2_name, proposed2_bykim)
        ...
        cv2.imwrite(f_pro3_name, proposed3_bykim)
        ...
        cv2.imwrite(g_pro4_name, proposed4_bykim)
        ...
        cv2.imwrite(h_pro5_name, proposed5_bykim)
